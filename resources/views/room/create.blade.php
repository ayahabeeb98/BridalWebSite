...
<!--======================================= create room Section =========================================== -->
    ...
    @csrf
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control " id="inputEmail4" placeholder="Room name" name="name" value="{{old('name')}}">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="number" min="0"  class="form-control" id="inputPassword4" placeholder="Number of Tables" name="tables" value="{{old('tables')}}">
            <span class="error col-md-12">{{$errors->first('tables')}}</span>
        </div>

        <div class="form-group col-md-6">
            <label for="inputPassword4">Number of Chairs</label>
            <input type="number" min="0" class="form-control" id="inputPassword4" placeholder="Number of Chairs" name="chairs" value="{{old('chairs')}}">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="number"  min="0"  class="form-control" id="inputPassword4" placeholder="The Price" name="price" value="{{old('price')}}">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="number"  min="0" class="form-control" id="inputPassword4" placeholder="Enter The Initial Price" name="earnest" value="{{old('earnest')}}">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="number"  min="0" class="form-control" id="inputPassword4" placeholder=" no_people" name="no_people" value="{{old('no_people')}}">
   ...
   <!--  <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="inputEmail4" placeholder="hall_name" name="hall_id" value="{{old('hall_id')}}">
            <span class="error col-md-12">{{$errors->first('hall_id')}}</span>

        </div>


    <button type="submit" class="btn btn-primary" style="background-color: #E73D89 ; border-color:#f5f5f5">Add Room</button>
</form>
                </div>
            </div>
        </div>
